...
export default function Dashboard() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      window.location.href = '/piano-xl.html';
    }, 2000);
        ...
        <div className="text-center">
          ...
          <div className="bg-[#1a1a1a] rounded-xl p-8 border border-[#333] max-w-md mx-auto shadow-[0_8px_32px_rgba(0,0,0,0.8)]">
            <div className="mb-6">
              ...
              <div className="inline-block px-4 py-2 bg-[#4ade80] text-black rounded-lg font-medium">
            ...
            <a
              href="/piano-xl.html"
              className="flex items-center justify-center space-x-2 bg-[#371d0b] hover:bg-[#4a2710] text-white px-6 py-3 rounded-lg font-medium transition-all shadow-[0_0_12px_rgba(55,29,11,0.6)] hover:shadow-[0_0_24px_rgba(55,29,11,0.8)]"
            >
